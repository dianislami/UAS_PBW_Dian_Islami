...
<div class="container-alumni">
    <div class="form-section">
        <div class="form-header">
            ...
            <p>Bagikan kesempatan karier untuk para alumni</p>
        </div>

        <div class="form-container">
            <form method="POST" action="{{ route('lowongan_store') }}" id="create-form">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <select id="jenis_pekerjaan" name="jenis_pekerjaan" required>
                                ...
                                <option value="Tetap" {{ old('jenis_pekerjaan') == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            ...
                            <select id="sistem_kerja" name="sistem_kerja" required>
                                ...
                                <option value="WFO" {{ old('sistem_kerja') == 'WFO' ? 'selected' : '' }}>Work From Office (WFO)</option>
                                <option value="WFH" {{ old('sistem_kerja') == 'WFH' ? 'selected' : '' }}>Work From Home (WFH)</option>
                                <option value="Hybrid" {{ old('sistem_kerja') == 'Hybrid' ? 'selected' : '' }}>Hybrid</option>
                            </select>
                        </div>
                        @error('sistem_kerja')
                            <div class="error-message">
                ...
                <div class="form-group">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="8" 
                              placeholder="Deskripsikan detail pekerjaan, tanggung jawab, persyaratan, kualifikasi, dan benefit yang ditawarkan..." required>{{ old('deskripsi') }}</textarea>
                    <div class="form-help-text">
